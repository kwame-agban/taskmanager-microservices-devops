...
mvn clean package -DskipTests docker build -t api-gateway . docker build
-t auth-service . docker build -t task-service .
...
kubectl get pods -n taskmanager kubectl get svc -n taskmanager
